    ...
    <main className="bg-[var(--color-cream)] min-h-screen flex items-center justify-center p-6 select-none relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        <motion.div 
          ...
          className="absolute -top-[20%] -right-[10%] w-[50vw] h-[50vw] rounded-full bg-[radial-gradient(circle,rgba(138,158,126,0.06)_0%,rgba(247,243,237,0)_70%)] blur-[50px] mix-blend-multiply" 
        />
      </div>
      ...
      <div className="relative z-10 max-w-[600px] w-full bg-white rounded-[32px] p-10 md:p-16 shadow-[0_20px_60px_rgba(138,158,126,0.05)] border border-[rgba(138,158,126,0.15)] text-center">
        ...
        >
          <div className="uppercase tracking-[0.2em] text-[0.75rem] text-[var(--color-text-muted)] mb-3">
            Order Confirmed
          </div>
          ...
          <h1 className="font-serif text-[clamp(2.2rem,4vw,3rem)] font-light leading-[1.1] mb-4 text-[var(--color-text)]" style={{ fontFamily: 'var(--font-cormorant)' }}>
            Thank you for choosing <br/><em className="italic text-[var(--color-sage-dark)]">Puroable</em>
          </h1>
        ...
        >
          <Link 
            href="/"
            className="inline-flex py-[1.2rem] px-[3rem] tracking-[0.15em] uppercase text-[0.8rem] rounded-full bg-[var(--color-text)] text-[#F7F3ED] transition-all duration-300 hover:bg-[var(--color-earth-dark)] hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(196,168,130,0.3)] focus:outline-none"
          >
            Continue Shopping
          </Link>
        </motion.div>
